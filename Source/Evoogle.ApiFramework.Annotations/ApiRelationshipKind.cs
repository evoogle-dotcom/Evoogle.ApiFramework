...
/// <summary>
///     Identifies the structural kind of a declared API relationship.
/// </summary>
public enum ApiRelationshipKind
{
    ...
    /// <summary>
    ///     A many-to-many relationship modeled through an explicit association object that holds key
    ///     values referencing both sides.
    /// </summary>
    ManyToMany
    #endregion
}
