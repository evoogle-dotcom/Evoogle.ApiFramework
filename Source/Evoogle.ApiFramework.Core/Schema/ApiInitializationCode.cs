...
public enum ApiInitializationCode
{
    ...
    API_ENUM_TYPE_DUPLICATE_ENUM_VALUE_API_NAME,
    API_ENUM_TYPE_DUPLICATE_ENUM_VALUE_CLR_NAME,
    API_ENUM_TYPE_DUPLICATE_ENUM_VALUE_CLR_ORDINAL,
    API_ENUM_TYPE_INVALID_CLR_TYPE,
    API_ENUM_TYPE_NULL_OR_EMPTY_ENUM_VALUES,
    #endregion
    ...
    API_IDENTITY_SET_DUPLICATE_IDENTITY_API_NAME,
    API_IDENTITY_SET_INVALID_PRIMARY_IDENTITY_API_NAME,
    API_IDENTITY_SET_NULL_OR_EMPTY_IDENTITIES,
    API_IDENTITY_SET_UNRESOLVED_PRIMARY_IDENTITY,
    #endregion

    #region ApiIdentity Initialization Codes
    API_IDENTITY_DUPLICATE_PART_API_PROPERTY_NAME,
    API_IDENTITY_INVALID_API_NAME,
    API_IDENTITY_MIXED_ORDERED_AND_NAMED_IDENTITY_PARTS,
    API_IDENTITY_NULL_OR_EMPTY_IDENTITY_PARTS,
    #endregion
    ...
    API_PROPERTY_INVALID_CLR_FIELD_GETTER,
    API_PROPERTY_INVALID_CLR_FIELD_SETTER,
    API_PROPERTY_INVALID_CLR_PROPERTY_GETTER,
    API_PROPERTY_INVALID_CLR_PROPERTY_SETTER,
