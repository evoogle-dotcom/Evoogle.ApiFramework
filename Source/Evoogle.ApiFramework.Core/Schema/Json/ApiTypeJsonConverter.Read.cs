...
public partial class ApiTypeJsonConverter : JsonConverterBase<ApiType>
{
    ...
    private class ApiObjectTypeReadData
    {
        ...
        public List<KeyValuePair<string, ApiKeyType>>? ApiKeyTypes { get; set; }
        #endregion
    }
    ...
    private class ReadHandlers(PropertyNames propertyNames)
    {
        ...
        private static void HandleApiObjectTypeApiKeyTypes(ref Utf8JsonReader reader, DefaultReadContext<PropertyNames, ReadData, ReadHandlers> context)
        {
            ...
            while (reader.Read())
            {
                ...
                if (apiKeyType != null)
                {
                    context.ReadData.ApiObjectType!.ApiKeyTypes!.Add(new KeyValuePair<string, ApiKeyType>(keyTypeName, apiKeyType));
                }
            }
        }
