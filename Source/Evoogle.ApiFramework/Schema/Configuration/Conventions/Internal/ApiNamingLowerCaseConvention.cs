...
/// </summary>
internal sealed class ApiNamingLowerCaseConvention(ApiNamingConventionTargets targets = ApiNamingConventionTargets.All)
    : ApiNamingConvention(targets)
{
    ...
    public override string ConvertName(string apiName, ApiNamingConventionContext context)
    {
        ...
        return apiName.Transform(To.LowerCase);
    }
    #endregion
}
