    ...
    : ApiRelationshipBuilder(apiName, ApiRelationshipOneToOne.DefaultDeleteBehavior)
{
    ...
    public ApiRelationshipOneToOneBuilder AddRelationshipExtension(Type extensionType, object extension)
        => this.AddRelationshipExtension<ApiRelationshipOneToOneBuilder>(extensionType, extension);
    #endregion
    ...
    public ApiRelationshipOneToOneBuilder From
    (
    ...
    /// <returns>The current builder instance.</returns>
    public ApiRelationshipOneToOneBuilder From(Type clrPrincipalType, string apiPrincipalKeyName)
    {
        ArgumentNullException.ThrowIfNull(clrPrincipalType);
    ...
    public ApiRelationshipOneToOneBuilder To
    (
    ...
    public ApiRelationshipOneToOneBuilder WithDeleteBehavior(ApiRelationshipDeleteBehavior apiDeleteBehavior)
        => this.WithDeleteBehavior<ApiRelationshipOneToOneBuilder>(apiDeleteBehavior);
    #endregion
    ...
    /// </summary>
    internal ApiRelationshipOneToOneBuilder SetDependentEndBuilderCore(ApiRelationshipDependentEndBuilder builder)
    {
