...
public partial class ApiSchemaTests(ITestOutputHelper output) : XUnitTests(output)
{
    ...
    private class InitializeOwnerKeyPathTest : XUnitTest
    {
        #region User Supplied Properties
        public required ApiRelationshipOwnerKeyPath OwnerKeyPath { get; init; }
        public required Func<ApiSchema> BuildSchema { get; init; }
        public required Action<ApiSchema> AssertAction { get; init; }
        #endregion
        ...
        protected override void Arrange()
        {
            this.WriteLine($"OwnerKeyPath: {this.OwnerKeyPath}");
            this.WriteLine();
        }
        ...
        protected override void Act()
        {
            ...
            this.WriteLine($"Schema: {this.Schema?.ApiName}");
            this.WriteLine();
        }
        ...
        protected override void Assert()
        {
            ...
            this.AssertAction(this.Schema!);
        }
        #endregion
    }

    private class InitializeOwnerKeyPathThrowsTest : XUnitTest
    {
        #region User Supplied Properties
        public required ApiRelationshipOwnerKeyPath OwnerKeyPath { get; init; }
